    ...
    ui(new Ui::send_page)
{
    ...
    connect(thread_sec, SIGNAL(khalife(QString)), this, SLOT(put(QString)));
    connect(thread_sec, SIGNAL(finished()), thread_sec, SLOT(deleteLater()));
...
void send_page::put(QString temp)
{
